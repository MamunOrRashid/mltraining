...
#................
#my <- rpart(Survived ~ Pclass + Sex + Age, data=train, method="class")
#fancyRpartPlot(my)
#..........
...
# for all variable its create problem
mytree4_1 <- predict(mytree4, test, type="class")
prediction4_1 <- data.frame(PassengerId = test$PassengerId, Survived = mytree4_1)
write.csv(prediction4_1, file = "tree1.1.csv", row.names = FALSE)
